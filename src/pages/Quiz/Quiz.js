  ...
  return (
    <>
      <div
        className={` ${
          showResults
            ? "text-black bg-[#F8DE6E] h-full min-h-screen border-[20px] border-[#3706EF]"
            : "bg-black h-full min-h-screen border-[20px] border-[#FF0145]"
        }`}
      >
        <div className="p-10">
          <Hero />
        ...
        {quizVisible && (
          <>
            <div className="px-10">
                ...
                <div>
                  ...
                  <ul className="text-white text-base sm:text-lg">
                    {currentQuestion.options.map((option, index) => (
                      <li key={index} className="p-1 my-10">
                        <label className="p-5 lg:border-2 lg:border-[#520EDD]">
                          <input
                            type="radio"
                            name="answer"
                            className=""
              ...
              <h1 className="text-white text-base sm:text-lg opacity-60">
